...
public class ListBL extends HttpServlet {
	...
	static final String URL = "jdbc:mysql://localhost:3306/testdb?characterEncoding=UTF-8&serverTimezone=JST";
	static final String USERNAME = "root";
	//static final String PASSWORD = "ishi1196";
	static final String PASSWORD = "ujoi8zmk";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (senarq == null) {
				...
				SelectQuery = "select id,name,address,tel,categoryname from jyusyoroku join catego on jyusyoroku.categoryid = catego.categoryid where delete_flg = 0 limit "
				...
				SelectQuery = "select id,name,address,tel,categoryname from jyusyoroku join catego on jyusyoroku.categoryid = catego.categoryid where delete_flg = 0 address like "
